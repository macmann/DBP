...
export function DashboardLayout({ title, breadcrumbs, action, children }: DashboardLayoutProps) {
  return (
    <div className="min-h-[calc(100vh-6rem)] rounded-2xl border border-border bg-gradient-to-b from-surface-elevated to-surface shadow-sm md:grid md:grid-cols-[17rem_minmax(0,1fr)]">
      <Sidebar />
